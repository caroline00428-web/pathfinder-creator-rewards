...
async function main() {
  ...
  // Seed milestones — actual game reward tiers
  const ytMilestones = [
    [300, 300], [600, 600], [1000, 1000], [3000, 2000], [6000, 3000],
    [10000, 5000], [30000, 7000], [50000, 9000], [80000, 12000],
    [100000, 15000], [150000, 20000], [200000, 30000],
  ];
